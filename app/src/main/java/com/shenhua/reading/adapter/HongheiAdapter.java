 ...
 */
public class HongheiAdapter extends RecyclerView.Adapter<HongheiViewHolder> implements View.OnClickListener {
    ...
    public HongheiViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        HongheiViewHolder holder = new HongheiViewHolder(view);
...
class HongheiViewHolder extends RecyclerView.ViewHolder {

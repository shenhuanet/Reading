package com.shenhua.reading.view;
...
public class MaterialLayout extends LinearLayout {
    ...
    private void initTypedArray(Context context, AttributeSet attrs) {
        ...
        mCirclelColor = typedArray.getColor(R.styleable.MaterialLayout_fcolor, Color.LTGRAY);
        mDuration = typedArray.getInteger(R.styleable.MaterialLayout_fduration,
                DEFAULT_DURATION);
        mFrameRate = typedArray
                .getInteger(R.styleable.MaterialLayout_fframerate, DEFAULT_FRAME_RATE);
        mColorAlpha = typedArray.getInteger(R.styleable.MaterialLayout_falpha, DEFAULT_ALPHA);
        mCircleScale = typedArray.getFloat(R.styleable.MaterialLayout_fscale, DEFAULT_SCALE);
        typedArray.recycle();
    }
